# AntrophAI v0.41.99a GLW handoff build
...
v0.41.99a adds the first hosted DEV round entry pass. The client can now load canonical server state for an invite-token grant through the hosted game-service while keeping the v0.41.98 proof tooling available for diagnostics.
