# Hosted handoff notes - AntrophAI v0.41.99a
...
v0.41.99a adds the first hosted DEV round entry view. It loads canonical player state from the hosted game service using the invite-token grant while keeping the diagnostic proof panel available.
...
v0.41.99a is the hosted round entry and canonical state milestone for the DEV multiplayer scaffold.
